...
CREATE INDEX IF NOT EXISTS artifact_snapshots_skill_id_idx ON artifact_snapshots(skill_id);
CREATE INDEX IF NOT EXISTS skill_analyses_snapshot_id_idx ON skill_analyses(snapshot_id);
