...
- 已有 9 页 HTML 原型和设计规范。
- 已有新版产品蓝图、PRD 和技术设计。
- 尚无 Tauri、Rust 或 React 应用实现。
- 当前目录尚未初始化为 Git 仓库。
- 本机 Skill 和 Codex SQLite 数据已完成只读验证。

因此实施从工程基础和兼容性验证开始，不沿用旧计划中 2026-07-23 已启动的假设。
...
两名工程师基准日历周期约 17 周，包含阶段评审、测试和缓冲。
...
| M2 开发 | 2026-09-07 至 2026-10-02 | 导入、quarantine、恢复、GitHub/市场、更新 |
...
**目标**：只对受管 User Skill 提供可恢复的生命周期操作。
